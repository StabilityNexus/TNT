      ...
      <div className="container mx-auto py-24 px-4 sm:px-6 z-10 relative max-w-7xl">
        <div className="text-center mb-8 mt-2">
          ...
          <p className="text-slate-400 text-sm md:text-base max-w-xl mx-auto">
            View and manage all Trust Network Tokens received across different
            blockchain networks
          </p>
        </div>
                  ...
                  <CardHeader className="p-4 pt-3 pb-1">
                    <div className="flex justify-between items-start">
                      <div className="flex flex-col">
                        ...
                        >
                          <CardTitle className="text-base font-bold text-white line-clamp-1 tracking-tight">
                            {tnt.tokenName ||
            ...
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center p-4 py-8">
                ...
                <p className="text-slate-400 mb-6 max-w-sm">
                  You haven't received any Trust Network Tokens yet. Create your
